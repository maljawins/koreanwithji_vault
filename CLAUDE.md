# CLAUDE.md (legacy 보관본)

> 2026-09-15부터 현재 코딩 agent와 규칙서의 단일 출처는 [`AGENTS.md`](AGENTS.md)다. 아래 내용은 Claude Code 운용 당시의 보관 기록이며, 현재 작업 지침으로 쓰지 않는다.
...
- **결론 먼저, 그 다음 단계별 설명.** 원칙은 본 vault 내 [`.claude/skills/get-to-the-point-skill/SKILL.md`](.claude/skills/get-to-the-point-skill/SKILL.md)를 따른다.
...
**Agent가 읽는 순서**
```
Claude Code 실행 → CLAUDE.md → master_index.md → 00_daily_worklog.md → to_do.md → 필요 시 conversation_log.md 및 YYMMDD_log.md
```

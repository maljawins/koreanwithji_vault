...
description: Rewrites AI text so it reads like a person, with the full ban list of AI tells. Use for ads, emails, captions, landing pages, and anything a real reader will see.
---

# The Humanizer

Source: https://learnaiwithmariah.com/guides/make-ai-get-to-the-point/

## The job
Rewrite so a real reader never once thinks about how it was written. You are not making it casual and you are not making it clever. You are removing the tells.

## Banned words (these are the loudest tells)
...
## Banned shapes (this is the part most rewrites miss)
...
- Repeats a word rather than reaching for a thesaurus synonym that nobody says out loud.

## How to work
1. Ask me who the reader is and what I want them to do, if I have not said. One question, then start.
2. Rewrite it.
3. Then list every banned item you found in the original, quoted, so I learn the tells and stop writing them myself.
4. If I gave you a writing sample of mine, match my rhythm and my vocabulary over any rule above except the ban lists.

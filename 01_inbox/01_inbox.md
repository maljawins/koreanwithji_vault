...
작성 문체는 [`.claude/skills/get-to-the-point-skill/SKILL.md`](../.claude/skills/get-to-the-point-skill/SKILL.md)의 원칙을 따른다. 결론 먼저, 군더더기 없이. (기존 `SKILL/get-to-the-point-skill.md` 표기는 실제 경로와 달라 정정)
...
6. **수치는 실측한다.** 기억이나 다른 문서에서 베끼지 않는다 ([CLAUDE.md](../CLAUDE.md) §7).

...
```
02_course_creation\
├─ 02_course_creation.md          ← 이 파일. 지도
├─ course_plan.md                 ← 강의 제작 로드맵·계획의 유일한 출처 (실시/미실시 사항, 작업 규칙, 결정 기록, 리스크)
...
| 알고 싶은 것 | 열 파일 |
|---|---|
| **지금 할 일** | [`to_do.md`](../../01_inbox/conversation_log/to_do.md) |
| 전체 로드맵, 끝난 것과 남은 것 | [`course_plan.md`](course_plan.md) §2~§3 |
| 현황 수치, 4층 문서 구조 | [`course_plan.md`](course_plan.md) §4~§5 |
| lesson_spec 작업 4단계, 발췌 규칙, 파일명 규칙 | [`course_plan.md`](course_plan.md) §6~§7 |
...
| 사업 로드맵 (Phase 1~5) | [`_about/Koreanwithji_기획서_v6_260902.md`](../../_about/Koreanwithji_기획서_v6_260902.md) §2 |
| 브랜드 톤, 예문 작성 원칙 | [`_about/01_brand.md`](../../_about/01_brand.md) |

---

## 단일 출처 규칙

같은 사실을 두 곳에 쓰지 않는다. 어느 사실이 어느 파일 소관인지 여기서 정한다.
...
| 사업 로드맵 | [`_about/Koreanwithji_기획서_v6_260902.md`](../../_about/Koreanwithji_기획서_v6_260902.md) | |
